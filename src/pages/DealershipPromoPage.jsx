...
const GENERIC_DEALERSHIP_NAMES = [
  ...
  "CU AUTO SALES",
  "MARKOSIAN AUTO TOOELE",
  "MARKOSIAN AUTO OGDEN",
  "MARKOSIAN AUTO LOGAN",
  "MARKOSIAN AUTO TAYLORSVILLE",
  "REALITY AUTO SALES",
  "DEALS ON WHEELS",
  ...
  "BEST BUY AUTO",
  "VIP MOTORS PROVO",
  "VIP MOTORS WEST VALLEY",
  "GERDTS AUTO",
  "AUTO SELECT",
  "PAINTER MOTOR CO.",
  "SUMMIT AUTOMOTIVE GROUP",
  "LUCKY'S AUTO CREDIT OGDEN",
  "LUCKY'S AUTO CREDIT WEST VALLEY",
  "LUCKY'S AUTO CREDIT SANDY",
